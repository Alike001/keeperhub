...
/**
 * The closed sets the two latency labels may take.
 *
 * Allowlisted here because this validator is the last thing before a value
 * arrives at a metric label: `observation-applier.ts` writes `triggerType` and
