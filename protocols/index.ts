 ...
 *
 * Registered protocols: aave-v3, aave-v4, aerodrome, ajna, chainlink, chronicle, coinbase-cbeth, compound, cowswap, curve, ethena, frax-ether-v2, hyperliquid, layerzero, lido, morpho, pendle, pyth, renzo, robinhood, rocket-pool, safe, sky, spark, superfluid, uniswap, wrapped, yearn
 */
...
registerIntegration(protocolToPlugin(renzoDef));
